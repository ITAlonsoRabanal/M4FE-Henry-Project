...
export const productsArray: IProduct[] = [
    {
      ...
      price: 699,
      stock: 10,
      image: "https://www.apple.com/autopush/ww/search/modules/iphone/image__e02dvfynhm6a_large_2x.jpg?",
      categoryId: 1
    },
    {
      id: 2,
      ...
      price: 999,
      stock: 10,
      image: "https://www.apple.com/autopush/ww/search/modules/macbookair/image__drus8vopfhkm_large_2x.jpg?",
      categoryId: 2
    },
    {
      id: 3,
      ...
      price: 799,
      stock: 10,
      image: "https://www.apple.com/autopush/ww/search/modules/ipadpro/image__ckyqvvzzj6xe_large_2x.jpg?",
      categoryId: 3
    },
    {
      id: 4,
      ...
      price: 399,
      stock: 10,
      image: "https://www.apple.com/autopush/ww/search/modules/applewatchseries10/image__9fn9bx0bnc2m_large_2x.jpg?",
      categoryId: 4
    },
    {
      id: 5,
    ...
    },
    {
      ...
      price: 99,
      stock: 10,
      image: "https://www.apple.com/autopush/ww/search/modules/macmini/image__btf9kdvrqh36_large_2x.jpg?",
      categoryId: 6
    }
  ]

  export const catchLinesArray = [
